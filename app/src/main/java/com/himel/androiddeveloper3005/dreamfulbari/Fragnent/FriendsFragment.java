...
import com.himel.androiddeveloper3005.dreamfulbari.Activity.UsersActivity;
import com.himel.androiddeveloper3005.dreamfulbari.AppConstant.Constans;
import com.himel.androiddeveloper3005.dreamfulbari.Model.Friends;
            ...
            protected void populateViewHolder(final FriendsViewHolder friendsViewHolder, Friends friends, int i) {
                ...
                mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        friendsViewHolder.setUserImage(userThumb, getActivity());
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        if(i == 0){
                                            ...
                                            Intent profile_intent = new Intent(getContext(), MessengerUserProfileActivity.class);
